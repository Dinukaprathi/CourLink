    ...
    <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-green-400">Court Link</h2>
          <p className="text-gray-400">
            Your premier destination for seamless turf and court bookings.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="text-gray-400 hover:text-white">Find Courts</a></li>
        ...
        {/* Newsletter */}
        <div>
          <h3 className="text-lg font-semibold text-green-400 mb-4">Newsletter</h3>
          <p className="text-gray-400 mb-4">Subscribe to get updates on new courts and offers.</p>
          <form className="flex">
            <input 
              type="email" 
      ...
      <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
        <p>&copy; {new Date().getFullYear()} Court Link. All rights reserved.</p>
        <div className="flex justify-center space-x-6 mt-4">
          ...
          <a href="#" className="text-gray-500 hover:text-gray-400">Sitemap</a>
        </div>
      </div>
    </footer>
  );
