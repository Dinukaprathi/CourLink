        ...
        <div className="hidden md:block md:w-1/2 relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-green-900/50 to-blue-900/70 flex items-center justify-center p-8">
            <div className="text-white">
              <h2 className="text-4xl font-bold mb-4">Join Court Link</h2>
              <p className="text-xl mb-6">Create your account to book sports courts</p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-8 bg-green-400 rounded-full"></div>
                  <span className="text-lg">Easy booking in just a few clicks</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-8 bg-blue-400 rounded-full"></div>
                  <span className="text-lg">Reserve prime time slots</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-8 bg-yellow-400 rounded-full"></div>
                  <span className="text-lg">Manage all your bookings in one place</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">Join Court Link today and start booking</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center mt-2">
                ...
                <label htmlFor="terms" className="text-sm text-gray-700">
                  I agree to the <Link to="/terms" className="text-green-600 hover:text-green-800">Terms of Service</Link> and <Link to="/privacy" className="text-green-600 hover:text-green-800">Privacy Policy</Link>
                </label>
              </div>
